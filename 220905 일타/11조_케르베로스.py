...
while True:
    ...
    # 1,3만 있을때 3번 우선 타격 (가장 가능성은 아직 x)

    if order == 1:
        if balls[3][0] > -1 and balls[3][1] > -1:
            target = (balls[3][0], balls[3][1])
        elif balls[1][0] > -1 and balls[1][1] > -1:
            target = (balls[1][0], balls[1][1])
        elif balls[5][0] > -1 and balls[5][1] > -1:
            target = (balls[5][0], balls[5][1])

    elif order == 2:
        if balls[2][0] > -1 and balls[2][1] > -1:
            target = (balls[2][0], balls[2][1])
        elif balls[4][0] > -1 and balls[4][1] > -1:
            target = (balls[4][0], balls[4][1])
        elif balls[5][0] > -1 and balls[5][1] > -1:
            target = (balls[5][0], balls[5][1])
    ...
    # 검정 공
    blackBall_x = balls[5][0]
    blackBall_y = balls[5][1]
